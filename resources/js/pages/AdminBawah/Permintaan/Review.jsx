...
export default function Review({
    ...
    // Inisialisasi status checklist: default true jika status !== 2
    ...
    // Inisialisasi catatan: dari comment yang sudah ada
    ...
    const handleConfirmSubmit = () => {
        ...
        router.post(
            `/adminBawah/permintaan/${encodeURIComponent(tiket.no_tiket)}/submit`,
            payload,
            {
                ...
                onError: (errors) => {
                    setSubmitting(false);
                    setErrorAlert(
                        Object.values(errors)[0] || 'Terjadi kesalahan saat menyimpan review usulan.'
                    );
                    window.scrollTo({ top: 0, behavior: 'smooth' });
                },
                onFinish: () => {
    ...
    return (
        <AuthenticatedLayout user={auth?.user}>
            <Head title={`Review Usulan - ${tiket.no_tiket || ''} - Front Office - PILKB`} />
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-lg sm:text-xl font-bold tracking-tight text-slate-900 dark:text-white">
                                Review Usulan Layanan
                            </h1>
                        </div>
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 pl-11">
                            Pemeriksaan dan validasi berkas fisik / digital pemohon sebelum diteruskan ke Admin Bidang.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2.5 flex-wrap self-start md:self-auto">
                        ...
                        >
                            ...
                            <span>Kembali ke List Permintaan</span>
                        </Link>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <div className="lg:col-span-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 shadow-xs space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                                ...
                                <div>
                                    <span className="text-slate-400 font-medium">Bidang Pengampu:</span>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-slate-400 mt-0.5">
                                        Periksa fisik/digital dokumen. Centang jika SESUAI, kosongkan jika PERLU PERBAIKAN (BTL).
                                    </p>
                                </div>
                            </div>
                                                    ...
                                                    <td className="px-4 py-3.5">
                                                        {isValid ? (
                                                            <div className="flex items-center gap-1.5 text-emerald-600 dark:text-emerald-400 text-xs font-medium">
                                                                ...
                                                                <span>Berkas tervalidasi & siap diproses</span>
                                                            </div>
                                                        ) : (
                                                            <div className="space-y-1">
                                                                <input
                                                                    ...
                                                                    placeholder="Wajib diisi: alasan berkas tidak sesuai..."
                            ...
                            <div className="flex items-center gap-3 text-xs">
                                ...
                                {btlCount > 0 && (
                                    <span className="inline-flex items-center gap-1.5 font-semibold text-rose-700 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/60 px-3 py-1.5 rounded-xl border border-rose-200/80 dark:border-rose-800/60">
                                        ...
                                        <span>{btlCount} Berkas BTL (Perlu Revisi)</span>
                                    </span>
                                )}
                            </div>
                                ...
                                >
                                    {submitting ? (
                                        ...
                                        <>
                                            ...
                                            <span>Simpan Review Usulan</span>
                                        </>
                                    )}
                                </button>
                            </div>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl p-6 z-10 animate-in fade-in zoom-in-95 duration-150 space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-sm font-bold text-slate-900 dark:text-white">
                                        {allValid ? 'Konfirmasi Berkas Sesuai' : 'Konfirmasi Berkas BTL'}
                                    </h3>
                            ...
                            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-300 space-y-2">
                                {allValid ? (
                                    <p>
                                        Seluruh berkas persyaratan (<strong className="text-emerald-600">{validCount} berkas</strong>) dinyatakan <strong className="text-emerald-600">SESUAI</strong>. Usulan akan diteruskan ke Admin Bidang untuk proses verifikasi lanjutan.
                                    </p>
                                ) : (
                                    <p>
                                        Terdapat <strong className="text-rose-600">{btlCount} berkas</strong> yang dinyatakan <strong className="text-rose-600">PERLU PERBAIKAN (BTL)</strong>. Tiket akan ditandai belum diperbaiki dan pemberitahuan catatan perbaikan akan dikirimkan ke Admin OPD / Pemohon.
                                    </p>
                                )}
                            </div>
