...
export default function Index({
    ...
    const filteredData = useMemo(() => {
        ...
        // Live Search Filter (No Tiket, NIP, Nama, Layanan, Unit Kerja)
        if (searchQuery.trim()) {
    ...
    const exportPdfUrl = hasDateRange
        ? `/adminBawah/laporan/export-pdf?bidang=${encodeURIComponent(bidangFilter)}&layanan=${encodeURIComponent(layananFilter)}&tanggal_awal=${encodeURIComponent(activeStart)}&tanggal_akhir=${encodeURIComponent(activeEnd)}`
        : '#';
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="py-3.5 px-4 whitespace-nowrap align-middle">
                                                                <div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80 text-[11px] font-mono font-semibold text-slate-800 dark:text-slate-200">
                                                            ...
                                                            {/* Info Pemohon (Avatar Bulat Slate - Bagian 6 Standard.md) */}
                                                            <td className="py-3.5 px-4 align-middle">
                                                                <div className="flex items-center gap-2.5">
                                                                    ...
                                                                    <div className="min-w-0">
                                                                        ...
                                                                        <div
                                                                            className="text-[11px] text-slate-500 dark:text-slate-400 truncate max-w-[180px]"
                                                            ...
                                                            {/* Layanan Kepegawaian (Line Clamp 2 - Bagian 6 Standard.md) */}
                                                            <td className="py-3.5 px-4 align-middle">
                                                                <span
                                                            ...
                                                            {/* Tanggal Masuk */}
                                                            <td className="py-3.5 px-4 whitespace-nowrap text-slate-600 dark:text-slate-300 align-middle">
                                                            ...
                                                            {/* Penerima Berkas */}
                                                            <td className="py-3.5 px-4 text-slate-600 dark:text-slate-300 whitespace-nowrap align-middle">
                                                                {item.nama_penerima || '-'}
                                                            </td>
