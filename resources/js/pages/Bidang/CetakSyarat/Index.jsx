...
export default function Index({
    ...
    // Syarat data — dikelola lokal agar responsif tanpa reload halaman
    ...
    // Sync state ketika props berubah (misal navigasi)
    useEffect(() => {
    ...
    // Handle Bidang Change — client-side tanpa reload halaman
    const handleBidangChange = (newBidangId) => {
        ...
        // Filter layanan dari allLayanan secara instan
    ...
    // Handle Layanan Change — fetch syarat via API tanpa reload halaman
    const handleLayananChange = (newLayananId) => {
        ...
        fetch(`/adminBidang/get-syarat-by-layanan/${newLayananId}`, {
            headers: {
    ...
    // Export PDF URL khusus Admin Bidang
    const exportPdfUrl = hasSelectedLayanan
        ? `/adminBidang/cetakSyarat/export?bidang=${encodeURIComponent(currentBidang)}&layanan=${encodeURIComponent(currentLayanan)}`
        : '#';
