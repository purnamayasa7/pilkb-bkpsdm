...
export default function SyaratBidangCreate({
    bidang = null,
    layanan = [],
    syaratEfile = [],
    ...
    const { data, setData, post, processing, errors } = useForm({
        kode_layanan: selectedLayananId ? String(selectedLayananId) : '',
        syarat: '',
        metode: 'simpeg', // 'simpeg' | 'upload'
        kode_efile: '',
        deskripsi: '',
    });
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Tambah Persyaratan Layanan - PILKB" />
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 pl-11">
                            Definisikan dokumen persyaratan dan metode integrasi SIMPEG untuk layanan di bidang {namaBidang}.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2.5 flex-wrap">
                        ...
                        <Link
                            href={
                                data.kode_layanan
                                    ? `/adminBidang/syarat?layanan=${data.kode_layanan}`
                                    : '/adminBidang/syarat'
                            }
                    ...
                    <div className="px-6 py-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-400">
                                Lengkapi rincian dokumen persyaratan di bawah ini
                            </p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); setConfirmModal(true); }} className="p-6 sm:p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                placeholder="Contoh: SK Kenaikan Pangkat Terakhir, Ijazah Terakhir, Surat Pengantar OPD..."
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs animate-in fade-in duration-150">
                    <div className="w-full max-w-md rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl p-6 space-y-4 animate-in zoom-in-95 duration-150">
                        ...
                        <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-300 space-y-1">
                            <p>
                                Dokumen persyaratan baru akan ditambahkan ke layanan terkait.
                            </p>
