...
export default function Index({
    ...
    // Calculate Summary Stats based on archives == 1 rule
    const stats = useMemo(() => {
    ...
    const filteredTiket = useMemo(() => {
        return tiket.filter((item) => {
            ...
            if (statusFilter === 'PROSES') {
                if (isArchived || st.includes('btl') || st.includes('perbaikan') || st.includes('revisi')) {
                    return false;
                }
    ...
    return (
        <AuthenticatedLayout user={auth?.user}>
            <Head title={`Laporan Layanan - ${namaBidang} - PILKB`} />
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-lg sm:text-xl font-bold tracking-tight text-slate-900 dark:text-white">
                                Laporan Layanan - {namaBidang}
                            </h1>
                        </div>
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 pl-11">
                            {hasDateRange ? (
                                <>
                                    Rekapitulasi pengajuan usulan layanan pada bidang{' '}
                                ...
                                `Pilih rentang tanggal untuk melihat laporan usulan layanan pada bidang ${namaBidang}.`
                            )}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2.5 self-start md:self-auto">
                        <a
                            href={
                                hasDateRange
                                    ? `/adminBidang/laporan/export-pdf?start_date=${encodeURIComponent(activeStart)}&end_date=${encodeURIComponent(activeEnd)}`
                                    : '#'
                            }
                            onClick={(e) => {
                                if (!hasDateRange) {
                ...
                {!hasDateRange ? (
                    ...
                    <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 py-16 px-4 text-center shadow-xs">
                        ...
                        <p className="text-xs text-slate-400 max-w-sm mx-auto mt-1">
                            Belum ada tiket pengajuan usulan yang tercatat pada bidang {namaBidang} untuk rentang tanggal{' '}
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                            <div className="relative flex-1 max-w-md">
                                ...
                                <input
                                    ...
                                    placeholder="Cari No Tiket, NIP, Nama pegawai, layanan, atau OPD..."
                                                            ...
                                                            <td className="py-3.5 px-4 lg:px-6 align-middle text-center whitespace-nowrap">
                                                                <div className="flex items-center justify-center gap-1.5">
                                                                    <button
                                                                        ...
                                                                        className="p-1.5 rounded-lg text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/50 border border-blue-200/80 dark:border-blue-900/50 transition-colors cursor-pointer"
                                                                    >
                ...
                <RiwayatTahapanModal
                    ...
                    noTiket={selectedTiket?.no_tiket}
                />
            </div>
        </AuthenticatedLayout>
    );
