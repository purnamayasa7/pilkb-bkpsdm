...
export default function Edit({
    ...
    const handleSubmit = (e) => {
        ...
        if (!statusTahap) {
            setErrorAlert('Silakan pilih Status Proses Tahap terlebih dahulu.');
        ...
        // Backend checks `isset($request->status[$detail->id])`
        ...
        router.post(
            `/adminBidang/permintaan/${encodeURIComponent(tiket.no_tiket)}/update`,
            payload,
            {
                ...
                onError: (errors) => {
                    setSubmitting(false);
                    setErrorAlert(
                        Object.values(errors)[0] || 'Terjadi kesalahan saat menyimpan review.'
                    );
                },
                onFinish: () => {
                    setSubmitting(false);
    ...
    return (
        <AuthenticatedLayout user={auth?.user}>
            <Head title={`Verifikasi Dokumen - ${tiket.no_tiket} - PILKB`} />
            ...
            <div className="space-y-6 max-w-7xl mx-auto pb-12">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-lg sm:text-xl font-bold tracking-tight text-slate-900 dark:text-white">
                                Verifikasi & Update Status Permintaan
                            </h1>
                        </div>
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 pl-11">
                            Verifikasi berkas persyaratan pemohon dan perbarui status tahapan pemrosesan tiket usulan.
                        </p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="mt-2.5 flex items-start gap-2.5 p-3 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-200 text-xs shadow-2xs animate-in fade-in duration-200">
                                        ...
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-[11px] text-emerald-700 dark:text-emerald-300/90 leading-relaxed">
                                                Usulan akan otomatis diarsipkan dan selesai tanpa proses terpisah
                                            </p>
                                        </div>
                                    </div>
                                ) : (
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Berkas telah diverifikasi teknis dan siap diproses"
                    ...
                    <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 overflow-hidden shadow-xs">
                        ...
                        {/* SINGLE RESPONSIVE TABLE CONTAINER */}
