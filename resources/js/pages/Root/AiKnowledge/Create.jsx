...
export default function RootAiKnowledgeCreate() {
    // Form state
    ...
    const handleConfirmSubmit = () => {
        ...
        router.post('/root/ai-knowledge', formData, {
            forceFormData: true,
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Tambah Materi Pengetahuan LILI - PILKB" />
            ...
            <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h1 className="text-lg sm:text-xl font-bold tracking-tight text-slate-900 dark:text-white">
                                Tambah Materi Pengetahuan LILI
                            </h1>
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                Tambahkan regulasi, SE Bupati, atau juknis kepegawaian baru ke basis pengetahuan LILI AI.
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="flex items-center gap-2.5 pb-4 mb-5 border-b border-slate-100 dark:border-slate-800">
                                ...
                                <div>
                                    <h3 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">
                                        Detail Materi Pengetahuan
                                    </h3>
                                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                                        Isi seluruh informasi regulasi, SE Bupati, atau juknis kepegawaian.
                                    </p>
                                </div>
                            </div>

                            <form onSubmit={handlePreSubmit} id="form-create" className="space-y-5">
                                {/* Kategori */}
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        placeholder="Contoh: Ketentuan Jam Kerja ASN saat Ramadhan"
                                        maxLength={255}
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className={`min-h-[44px] flex flex-wrap gap-1.5 items-center px-3 py-2 rounded-xl border bg-slate-50/50 dark:bg-slate-950/50 transition-all ${errors.kata_kunci ? 'border-rose-300 dark:border-rose-800 focus-within:ring-2 focus-within:ring-rose-500/20 focus-within:border-rose-500' : 'border-slate-200 dark:border-slate-800 focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500'}`}>
                                        {kataKunci.map((kk, i) => (
                                    ...
                                    <div className={`rounded-xl border overflow-hidden bg-slate-50/50 dark:bg-slate-950/50 ${errors.konten_jawaban ? 'border-rose-300 dark:border-rose-800' : 'border-slate-200 dark:border-slate-800 focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500'}`}>
                                        {previewMode ? (
                                            ...
                                            <textarea
                                                ...
                                                placeholder="Tulis konten jawaban LILI... (mendukung Markdown: **tebal**, *miring*, - bullet, 1. nomor)"
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                                        Saran Pertanyaan Lanjutan <span className="text-slate-400 font-normal">(maks 4 — akan tampil sebagai tombol pilihan cepat di chat LILI)</span>
                                    </label>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        {saran.map((s, i) => (
                                            <input
                                                ...
                                                placeholder={`Chip ${i + 1}: contoh "Apa hukumannya jika terlambat?"`}
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div
                                        ...
                                        className={`relative rounded-xl border-2 border-dashed transition-all cursor-pointer ${dragOver ? 'border-blue-500 bg-blue-50 dark:bg-blue-950/40' : 'border-slate-200 dark:border-slate-700 hover:border-blue-400 hover:bg-slate-50 dark:hover:bg-slate-800/50'} ${pdfFile ? 'cursor-default' : ''}`}
                                    >
                                        <input
                                            ref={fileInputRef}
                                            type="file"
                                        ...
                                        {pdfFile ? (
                                            <div className="flex items-center justify-between p-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="p-2 rounded-lg bg-rose-50 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400 border border-rose-200/80 dark:border-rose-900/50">
                                                        <FileText className="w-5 h-5" />
                                                    </div>
                                                    <div>
                                                        <p className="text-xs font-semibold text-slate-800 dark:text-slate-200 truncate max-w-[220px]">{pdfFile.name}</p>
                                                        <p className="text-[11px] text-slate-400 mt-0.5">{(pdfFile.size / 1024 / 1024).toFixed(2)} MB</p>
                                                    </div>
                                                </div>
                                                <button
                                                    type="button"
                                            ...
                                            <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
                                                ...
                                                <p className="text-xs font-semibold text-slate-600 dark:text-slate-400">Klik atau seret file PDF ke sini</p>
                                ...
                                <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                                    ...
                                    >
                                        <Save className="w-4 h-4" /> Simpan Materi
                                    </button>
                                </div>
                            </form>
                        </div>
                    ...
                    {/* ── Kolom Kanan: Panduan + Toggle + Simulator ─────── */}
                    <div className="space-y-5">
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-[11px] text-slate-400 mt-0.5 text-left">
                                        {isActive ? 'Materi ini aktif saat disimpan.' : 'Materi disimpan namun tidak aktif.'}
                                    </p>
                                </div>
                                {isActive
                        ...
                        <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 shadow-xs">
                            <div className="flex items-center gap-2.5 pb-4 mb-4 border-b border-slate-100 dark:border-slate-800">
                                ...
                                <h3 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">
                                    Alur Pemrosesan LILI
                                </h3>
                            </div>
                            <div className="space-y-3 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                                <div className="flex items-start gap-2.5">
                                    <span className="w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[11px] font-bold text-slate-700 dark:text-slate-300 shrink-0">1</span>
                                    <p>Pengguna mengajukan pertanyaan di ruang percakapan asisten LILI.</p>
                                </div>
                                <div className="flex items-start gap-2.5">
                                    <span className="w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[11px] font-bold text-slate-700 dark:text-slate-300 shrink-0">2</span>
                                    <p>LILI memeriksa kata kunci pencocokan pada basis data dinamis (Layer 0).</p>
                                </div>
                                <div className="flex items-start gap-2.5">
                                    <span className="w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[11px] font-bold text-slate-700 dark:text-slate-300 shrink-0">3</span>
                                    <p>Jika cocok, materi ini dijadikan rujukan prioritas utama (di atas Gemini AI).</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50">
                                    <div className="flex items-center gap-2.5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-slate-400">Uji respon cerdas LILI secara instan</p>
                                        </div>
                                    </div>
                                    <button
                                        type="button"
                                ...
                                <div className="h-64 overflow-y-auto p-4 space-y-3 bg-slate-50/40 dark:bg-slate-950/40">
                                    {simHistory.length === 0 && (
                                        <div className="flex flex-col items-center justify-center h-full text-center py-6">
                                            ...
                                            <p className="text-[11px] text-slate-400 mt-0.5 max-w-[200px]">Ketik pertanyaan di bawah untuk menguji respon LILI.</p>
                                        </div>
                                    )}
                    ...
                    <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl p-6 space-y-4 animate-in zoom-in-95 duration-150">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-bold text-sm">
                                ...
                                <span>Konfirmasi Simpan Materi</span>
                            </div>
                        ...
                        <div className="space-y-2 text-xs text-slate-600 dark:text-slate-300">
                            <p>Simpan materi pengetahuan berikut ke basis data LILI AI?</p>
                        ...
                        <div className="flex items-center justify-end gap-2.5 pt-2">
                            ...
                            <button type="button" onClick={handleConfirmSubmit} disabled={submitting} className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-semibold text-xs transition-colors shadow-2xs cursor-pointer">
                                {submitting ? <><Loader2 className="w-3.5 h-3.5 animate-spin" /><span>Menyimpan...</span></> : <><Save className="w-3.5 h-3.5" /><span>Ya, Simpan</span></>}
                            </button>
                        </div>
                    </div>
                </div>
