...
export default function RootFaqCreate() {
    // Form state
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                Tambahkan materi tanya-jawab umum baru untuk memandu pengguna aplikasi PILKB.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 pb-6 mb-6 border-b border-slate-100 dark:border-slate-800">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                                Masukkan pertanyaan yang sering ditanyakan beserta jawaban panduan yang jelas.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="Contoh: Bagaimana cara mengajukan kenaikan pangkat pada PILKB?"
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <textarea
                                    ...
                                    placeholder="Tuliskan uraian langkah atau penjelasan lengkap terkait pertanyaan di atas..."
                        ...
                        <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700/60 flex items-start gap-3">
                            ...
                            <div className="text-xs space-y-1">
                                <div className="font-semibold text-slate-800 dark:text-slate-200">
                                    Petunjuk Penyusunan FAQ
                                </div>
                                <p className="text-slate-500 dark:text-slate-400 text-[11px] leading-relaxed">
                                    Gunakan tata bahasa yang lugas, mudah dimengerti oleh pemohon, dan sertakan rincian alur atau dokumen pendukung bila diperlukan. FAQ ini dapat langsung dibaca oleh pengguna sistem.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden p-6 space-y-4 animate-in zoom-in-95 duration-150">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-bold text-sm">
                                ...
                                <span>Konfirmasi Simpan FAQ</span>
                            </div>
                            <button
                                type="button"
                        ...
                        <div className="space-y-2 text-xs text-slate-600 dark:text-slate-300">
                            <p>Apakah Anda yakin ingin menyimpan FAQ baru ini?</p>
