...
export default function RootLayananEdit({ layanan, bidang = [] }) {
    ...
    const [waktuPenyelesaian, setWaktuPenyelesaian] = useState(layanan?.waktu_penyelesaian || '');
    ...
    const handlePreSubmit = (e) => {
        ...
        if (!waktuPenyelesaian.trim()) {
            newErrors.waktu_penyelesaian = 'Waktu penyelesaian wajib diisi.';
        }
        if (aktif !== '1' && aktif !== '0') {
    ...
    const handleConfirmSubmit = () => {
        ...
        router.put(
            `/root/layanan/${layanan.id}`,
            {
                ...
                waktu_penyelesaian: waktuPenyelesaian.trim(),
            ...
            <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                Perbarui informasi nama, bidang pengampu, estimasi waktu, deskripsi, dan status layanan
                            </p>
                        </div>
                    </div>
                ...
                <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-xs">
                    ...
                    <form onSubmit={handlePreSubmit} className="space-y-6">
                        ...
                        {/* Field Waktu Penyelesaian */}
                        <div className="space-y-1.5">
                            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                                <span>
                                    Estimasi Waktu Penyelesaian <span className="text-rose-500">*</span>
                                </span>
                            </label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (errors.waktu_penyelesaian) {
                                            setErrors((prev) => ({ ...prev, waktu_penyelesaian: null }));
                                        }
                                    }}
                                    placeholder="Contoh: 3 Hari Kerja, 1 Minggu, dll"
