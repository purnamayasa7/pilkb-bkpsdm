...
<head>
    ...
    <!-- Anti-Flash Theme Script (Default Light Mode, tersimpan di localStorage saat diubah) -->
    <script>
        (function () {
            try {
    ...
    <!-- Firebase App & Database Scripts (jika diperlukan untuk chat & notifikasi realtime) -->
