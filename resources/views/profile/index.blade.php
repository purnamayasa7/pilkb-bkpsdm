                         ...
                         <form id="formUpdate" method="POST" action="{{ route('profile.update') }}">
                             ...
                             <div class="mb-3">
                                 ...
                                 <input class="form-control" id="username" name="username" type="text"
                                     placeholder="Masukkan username" value="{{ $user->username }}" disabled />
                             </div>
                             <div class="mb-3">
                             ...
                             <div class="mb-3">
                                 ...
                                 <select name="bidang_id" class="form-select" required>
                                     ...
                                     <option value="admin_bawah"
                                         {{ $user->bidang_id == 'admin_bawah' ? 'selected' : '' }}>
                                         Admin Bawah
                                     </option>

                                     <option value="admin_opd" {{ $user->bidang_id == 'admin_opd' ? 'selected' : '' }}>
                                         Admin OPD
                                     </option>

                                     @foreach ($bidang as $b)
                                         <option value="{{ $b->id }}"
                                             {{ $user->bidang_id == $b->id ? 'selected' : '' }}>
                                             {{ $b->nama_bidang }}
                                         </option>
                                     @endforeach
                                 </select>
                             ...
                             <div class="mb-3">
                                 ...
                                 <input class="form-control" id="jabatan" name="jabatan" type="text"
                                     placeholder="Masukkan jabatan" value="{{ $user->jabatan }}" required />
                             </div>

                             <div class="mb-3">
                                 <label class="small mb-1" for="ukerja">Unit Kerja</label>
                                 <input class="form-control" id="kode_ukerja" name="kode_ukerja" type="text"
                                     placeholder="Masukkan unit kerja" value="{{ $user->kode_ukerja }}" required />
                             </div>
                             ...
                             <button class="btn btn-primary" type="button" id="btnUpdate">Update Data</button>
                         </form>
                     </div>
                 </div>
             </div>
