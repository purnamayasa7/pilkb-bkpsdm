        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Simpan Data Bidang</h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">Apakah anda yakin menyimpan data bidang ini?</div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="formRegister" method="POST" action="{{ route('root.bidang.store') }}">
                            @csrf

                            <div class="mb-3">
                                <label class="small mb-1">Nama Bidang</label>
                                @error('nama_bidang')
                                    <div class="text-danger mb-1">{{ $message }}</div>
                                @enderror

                                <input class="form-control @error('nama_bidang') is-invalid @enderror" name="nama_bidang"
                                    type="text" placeholder="Masukkan nama bidang" value="{{ old('nama_bidang') }}"
                                    required />
                            </div>
                            ...
                            <button class="btn btn-primary" type="button" id="btnTambah">
                                <i data-feather="save" class="me-1"></i> Tambah Bidang
                            </button>
                        </form>
                    </div>
                </div>
