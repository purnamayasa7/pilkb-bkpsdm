    ...
    <div class="modal fade" id="modalSimpan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Apakah anda yakin menyimpan perubahan FAQ ini?</div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="formUpdate" method="POST" action="{{ route('root.faq.update', $faq->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('jawaban') is-invalid @enderror" id="jawaban"
                                    name="jawaban" rows="5" placeholder="Masukkan jawaban FAQ" required>{{ old('jawaban', $faq->jawaban) }}</textarea>
                            </div>

                            <button class="btn btn-primary" type="button" id="btnUpdate">
                                <i data-feather="save" class="me-1"></i> Update FAQ
                            </button>
                        </form>
                    </div>
                </div>
