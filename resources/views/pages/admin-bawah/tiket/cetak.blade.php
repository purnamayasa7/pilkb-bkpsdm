...
<div class="container-fluid px-4 mt-4">
    <div class="card">
        <div class="card-body">
            ...
            <!-- FORM -->
            <form method="GET" action="{{ route('adminBawah.tiket.formCetakAdminBawah') }}" class="mb-4">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="keyword" class="form-control"
                                placeholder="Masukkan No Tiket / NIP" value="{{ request('keyword') }}">
                        </div>
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-center">
                                <a class="btn btn-datatable btn-icon btn-transparent-dark me-1"
                                    href="{{ route('tiket.cetak', $item->no_tiket) }}" target="_blank" data-bs-toggle="tooltip"
