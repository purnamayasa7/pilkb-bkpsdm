...
<style>
    ...
    /* =========================================================
       ...
       BADGE TIDAK BOLEH MEMPERBESAR BUTTON
       ========================================================= */
    ...
    /* =========================================================
       ...
       Tidak dibuat sebagai pengganti button.
       Supaya layout tetap rapi.
    ========================================================= */
...
<div class="container-fluid px-4">
    ...
    <form id="formPerbaikan" method="POST" action="{{ route('adminBawah.permintaan.submitPermintaan', $tiket->no_tiket) }}">
        @csrf
        <div class="card mb-4">
    ...
    ====================================================== --}}
                                            ...
                                            {{-- =====================================================
         SIMPEG LEBIH DARI 1 DOKUMEN
         TAMPILKAN MODAL DAFTAR DOKUMEN
    ====================================================== --}}
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | DATA DOKUMEN YANG SEDANG DIBUKA
        |--------------------------------------------------------------------------
        */
            ...
            filterDokumen.addEventListener(
                ...
                function() {
                    ...
                    if (value === 'latest') {
                        ...
                        /*
                         * Data sudah diurutkan DESC berdasarkan urutan
                         * dari controller.
                         */
