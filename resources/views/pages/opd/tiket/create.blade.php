        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-3 text-center"> <img id="detailFoto"
                                src="{{ asset('templatepro/assets/img/demo/user-placeholder.svg') }}"
                                class="img-fluid rounded" style="width: 170px; height: 200px; object-fit: cover;"> </div>
                        <div class="col-md-9">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-2"> <span><i
                                                data-feather="hash" class="me-1"></i> NIP</span> <span id="detailNip"
                                            class="text-end"></span> </div>
                                    <div class="d-flex justify-content-between align-items-center mb-2"> <span><i
                                                data-feather="user" class="me-1"></i> Nama</span> <span id="detailNama"
                                            class="text-end"></span> </div>
                                    <div class="d-flex justify-content-between align-items-center mb-2"> <span><i
                                                data-feather="layers" class="me-1"></i> Bidang</span> <span
                                            id="detailBidang" class="text-end"></span> </div>
                                    <div class="d-flex justify-content-between align-items-center mb-2"> <span><i
                                                data-feather="briefcase" class="me-1"></i> Jabatan</span> <span
                                            id="detailJabatan" class="text-end"></span> </div>
                                    <div class="d-flex justify-content-between align-items-center mb-2"> <span><i
                                                data-feather="home" class="me-1"></i> Unit Kerja</span> <span
                                            id="detailUkerja" class="text-end"></span> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form method="POST" action="{{ route('adminOpd.tiket.step') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="nipError" class="text-danger small" style="display:none;">
                                            NIP tidak ditemukan
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-label">
                                                {{ $tiket->layanan->bidang->nama_bidang ?? '-' }}</div>
                                        </div>
                                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (btnCek) {
                btnCek.addEventListener('click', function() {
                    ...
                    document.getElementById('detailNama').innerText = 'Kadek Purnamayasa, S.Kom';
                    document.getElementById('detailBidang').innerText = 'PPI';
                    document.getElementById('detailJabatan').innerText = 'Pranata Komputer';
                    document.getElementById('detailUkerja').innerText = 'BKPSDM Kabupaten Buleleng';
