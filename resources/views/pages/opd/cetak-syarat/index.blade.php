                ...
                <div class="col-12 col-xl-auto mb-3">
                    <div class="btn-group">
                        <a class="btn btn-sm btn-light text-success {{ $layananId ? '' : 'disabled' }}"
                            id="btnExportPdf"
                            href="{{ $layananId ? route('adminOpd.cetakSyarat.export', ['bidang' => $bidangId, 'layanan' => $layananId]) : 'javascript:void(0)' }}"
                            target="_blank"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateExportLink(bidangId, layananId) {
            ...
            btnExportPdf.href = `{{ route('adminOpd.cetakSyarat.export') }}?${params.toString()}`;
        }
        ...
        function loadSyarat(layananId) {
            ...
            fetch(`/adminOpd/get-syarat-by-layanan/${encodeURIComponent(layananId)}`)
                .then(res => res.json())
                .then(data => {
                    let rowsHtml = '';
        ...
        function loadLayanan(bidangId) {
            ...
            fetch(`/adminOpd/get-layanan-syarat/${encodeURIComponent(bidangId)}`)
