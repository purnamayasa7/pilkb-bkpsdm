...
<body>
    ...
    <div class="doc-title-container">
        <div class="doc-title">LAPORAN REKAPITULASI PERMINTAAN LAYANAN</div>
    </div>
    ...
    <table class="laporan-table">
        <thead>
            <tr>
                ...
                <th style="width: 21%;">Jenis Layanan</th>
            ...
            @empty
                <tr>
                    <td colspan="7" class="text-center" style="color: #64748b; padding: 12px;">
                        Tidak ada data permintaan layanan pada filter yang dipilih.
                    </td>
                </tr>
            @endforelse
        </tbody>
