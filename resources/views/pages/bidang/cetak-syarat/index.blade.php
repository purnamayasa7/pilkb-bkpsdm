            ...
            <div class="row align-items-center justify-content-between pt-3">
                <div class="col-auto mb-3">
                    <h1 class="page-header-title">
                        ...
                        Cetak Syarat - {{ auth()->user()->nama_bidang }}
                    </h1>
                </div>
                <div class="col-12 col-xl-auto mb-3">
                    <div class="btn-group">
                        <a class="btn btn-sm btn-light text-success {{ $layananId ? '' : 'disabled' }}"
                            id="btnExportPdf"
                            href="{{ $layananId ? route('adminBidang.cetakSyarat.exportPdfBidang', ['bidang' => $bidangId, 'layanan' => $layananId]) : 'javascript:void(0)' }}"
                            target="_blank"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateExportLink(bidangId, layananId) {
            ...
            btnExportPdf.href = `{{ route('adminBidang.cetakSyarat.exportPdfBidang') }}?${params.toString()}`;
        }
        ...
        function loadSyarat(layananId) {
            ...
            fetch(`/adminBidang/get-syarat-by-layanan/${encodeURIComponent(layananId)}`)
                .then(res => res.json())
                .then(data => {
                    let rowsHtml = '';
        ...
        function loadLayanan(bidangId) {
            ...
            fetch(`/adminBidang/get-layanan-syarat/${encodeURIComponent(bidangId)}`)
