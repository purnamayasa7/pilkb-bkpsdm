...
@section('content')
    ...
    <div class="container-fluid px-4 mt-4">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('adminBidang.cetakSyarat.indexCetakAdminBidang') }}" id="filterForm" class="mb-3">
                    <div class="bg-white p-3 rounded-3 mb-4 border">
                        <div class="row align-items-end">
                            ...
                            @if ($layananId)
                                <div class="col-md-4">
                                    <a href="{{ route('adminBidang.cetakSyarat.exportPdfBidang', [
                                        'bidang' => $bidangId,
                                        'layanan' => $layananId,
                                    ]) }}" target="_blank"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadLayanan(bidangId) {
                ...
                fetch(`/adminBidang/get-layanan-syarat/${bidangId}`)
                    .then(res => res.json())
                    .then(data => {
