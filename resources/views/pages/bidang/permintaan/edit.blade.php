...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="{{ route('adminBidang.permintaan.updatePermintaan', $tiket->no_tiket) }}">
            @csrf
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <select name="status_tahap" class="form-select" required>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <textarea name="catatan" class="form-control" rows="3" placeholder="Isi catatan proses"></textarea>
