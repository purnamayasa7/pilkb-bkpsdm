...
<div class="container-fluid px-4">
    <form id="formStatus" method="POST" action="{{ route('adminBidang.status.update', $tiket->no_tiket) }}">
                    ...
                    <div class="card-body p-3 p-md-4">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="fw-bold">{{ $dataPegawai['nama'] ?? '-' }}</div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="fw-bold">{{ $dataPegawai['unit'] ?? '-' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {{-- STATUS PROSES & CATATAN CARD --}}
        <div class="card summary-info-card border shadow-none mb-4">
            <div class="card-header py-2 px-3 fw-bold small d-flex align-items-center">
                <i data-feather="activity" class="me-2 text-primary" style="width: 16px; height: 16px;"></i>
                Update Status Tahap Proses
            </div>
            <div class="card-body p-3 p-md-4">
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label fw-semibold small mb-1" for="statusTahapSelect">
                            Pilih Status Proses <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <span class="input-group-text">
                                <i data-feather="layers" style="width: 16px; height: 16px;"></i>
                            </span>
                            <select name="status_tahap" id="statusTahapSelect" class="form-select" required>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold small mb-1" for="catatanInput">
                            Catatan Proses
                        </label>
                        <div class="input-group">
                            <span class="input-group-text">
                            ...
                            <input type="text" name="catatan" id="catatanInput" class="form-control"
                                placeholder="Isi catatan proses jika ada...">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-end gap-2 pt-3 border-top wizard-actions-end">
            <button type="submit" class="btn btn-primary px-4 d-inline-flex align-items-center" id="btnSimpanStatus">
