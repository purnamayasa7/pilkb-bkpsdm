        ...
        <div class="page-header-content">
            <div class="row align-items-center justify-content-between pt-3">
                ...
                <div class="col-12 col-xl-auto mb-3">
                    <a class="btn btn-sm btn-light text-primary" href="{{ route('adminBidang.status.createBidang') }}">
...
<div class="container-fluid px-4 mt-4">
    <div class="card">
        <div class="card-body">
            <form method="GET"
                action="{{ route('adminBidang.status.indexBidang') }}"
                class="mb-3">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a class="btn btn-datatable btn-icon btn-transparent-dark me-1"
                                        href="{{ route('adminBidang.status.editBidang', $item->id) }}" data-bs-toggle="tooltip"
